...
function applyBundle(b) {
  ...
  try {
    ...
    localStorage.setItem(KEYS.docs, JSON.stringify(bundle.docs));
    localStorage.setItem(KEYS.custom, JSON.stringify(bundle.custom));
    for (const k of [KEYS.tasks, KEYS.cases, KEYS.clauses, KEYS.docs, KEYS.custom]) {
